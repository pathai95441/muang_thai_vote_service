...
var (
	roleDBTypes = map[string]string{`ID`: `int`, `RoleName`: `varchar`, `Description`: `varchar`, `CreatedAt`: `timestamp`, `CreatedBy`: `varchar`, `UpdatedAt`: `timestamp`, `UpdatedBy`: `varchar`, `DeletedAt`: `timestamp`, `DeletedBy`: `varchar`}
	_           = bytes.MinRead
)
