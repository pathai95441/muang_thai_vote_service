...
func (m *MockICandidateDomain) GetAllCandidate(ctx context.Context, orderBy, search *string) (*[]candidate.Candidate, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllCandidate", ctx, orderBy, search)
...
func (mr *MockICandidateDomainMockRecorder) GetAllCandidate(ctx, orderBy, search interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllCandidate", reflect.TypeOf((*MockICandidateDomain)(nil).GetAllCandidate), ctx, orderBy, search)
}
