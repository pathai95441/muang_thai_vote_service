...
func (m *MockIGetAllCandidateQuery) Handle(ctx context.Context) (*[]candidate.Candidate, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIGetAllCandidateQueryMockRecorder) Handle(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Handle", reflect.TypeOf((*MockIGetAllCandidateQuery)(nil).Handle), ctx)
}
